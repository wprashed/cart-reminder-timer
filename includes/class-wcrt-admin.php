...
class WCRT_Admin {
    ...
    public static function menu(){
        add_submenu_page('woocommerce', 'Cart Reminder Timer', 'Cart Reminder Timer', 'manage_options', 'wcrt-settings', [__CLASS__, 'settings_page']);
    }
        ...
        <div class="wrap">
            ...
            <form method="post">
                <table class="form-table">
                    ...
                    <tr><th>Message for Logged-in Users</th>
                        <td><input type="text" name="wcrt_message_user" value="<?php echo esc_attr(get_option('wcrt_message_user','Hurry up! Your items are reserved.')); ?>"></td></tr>
                    <tr><th>Message for Guests</th>
                        <td><input type="text" name="wcrt_message_guest" value="<?php echo esc_attr(get_option('wcrt_message_guest','Hurry! Items reserved.')); ?>"></td></tr>
                    <tr><th>Enable A/B Testing</th>
                        <td><input type="checkbox" name="wcrt_ab_testing" <?php checked(get_option('wcrt_ab_testing'),1); ?>></td></tr>
                    <tr><th>Max Usage Per User</th>
                        <td><input type="number" name="wcrt_max_usage" value="<?php echo get_option('wcrt_max_usage',1); ?>"></td></tr>
                    <tr><th>Minimum Cart Amount to Start Timer</th>
                        <td><input type="number" step="0.01" name="wcrt_min_cart" value="<?php echo get_option('wcrt_min_cart',0); ?>"></td></tr>
                    <tr><th>Timer Position</th>
                        <td>
