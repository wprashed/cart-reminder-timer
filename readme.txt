...
3. **Notifications Tab** - Customize messages and enable email reminders
4. **Advanced Tab** - Enable A/B testing and view tracking information

== Frequently Asked Questions ==

= How long is the timer? =

The default timer is 15 minutes, but you can customize this in the settings. The timer resets when items are added or removed from the cart.
...
For support, questions, or feature requests, please visit the plugin repository or contact the developer.
...
This plugin is licensed under the GPL v2 or later. See LICENSE for more information.
