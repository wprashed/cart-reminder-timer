 ...
 * Text Domain: dealicious-cart-reminder-timer
...
define( 'CRT_TEXT_DOMAIN', 'dealicious-cart-reminder-timer' );
		...
		<p>
			...
			echo wp_kses_post(
				sprintf(
					...
					__( '<strong>Dealicious - Cart Reminder Timer for WooCommerce</strong> requires %s to be installed and activated.', CRT_TEXT_DOMAIN ),
